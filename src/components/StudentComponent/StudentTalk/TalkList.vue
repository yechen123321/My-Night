...
const GotoTalks = () => {
  router.push('/student/talk/talks')
}
</script>

<template>
  <div class='TalkList-body'>
    <div class='TalkList-body-top'>
      <div class='TuiJian'>推荐</div>
    </div>
    <div class='Main-body'>
      <div class='Talks-Cards' @click='GotoTalks'>
        <div class='Cards-left'>
          <div class='Cards-left-top'>
            <div class='word'>想要进入我们嘛？看看我们的考试试卷吧</div>
          </div>
          <div class='Cards-left-center'>
            <div class='word'>
        ...
        <div class='Cards-right'>
          <img src='/src/assets/StudentTalk/1.png' alt=''>
        </div>
      </div>
    </div>
  </div>
...
.TalkList-body {
  ...
  .Main-body {
    ...
    .Talks-Cards:hover {
      cursor: pointer;
      background-color: rgba(114, 112, 112, 0.05);
