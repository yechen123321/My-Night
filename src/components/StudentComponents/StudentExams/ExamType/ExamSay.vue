<script setup>
import CCCCC from '@/components/StudentComponents/StudentExams/ExamType/CCCCC.vue'
</script>

<template>
  <div class='ExamMain-say'>
    ...
    <div class='ExamBody'>
      <div class='QuestionTitle'>
        <div class='title'>口语题第 <span>1</span> 题</div>
        <div class='TitleWord'>
          说明：请根据给定话题进行陈述，你有一分钟的准备时间
        </div>
      </div>
      <div class='WorkBody'>
        ...
        <CCCCC style='margin-top: -1vh'></CCCCC>
      </div>
    </div>
  </div>
</template>
