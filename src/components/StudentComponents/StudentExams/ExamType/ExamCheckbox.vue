...
<template>
  <div class='ExamMain-checkbox'>
    <div class='ExamLeftList-checkbox'>
      <div class='top'>
        <div class='top-word'>已做题目数<span> 0/5</span></div>
      </div>
      <div class='QuestionBody'>
        <div class='Questionss' id='beChoose' @click='showQ'>1</div>
        <div class='Questionss' @click='showQ'>2</div>
        <div class='Questionss' @click='showQ'>3</div>
        <div class='Questionss' @click='showQ'>4</div>
        <div class='Questionss' @click='showQ'>5</div>
      </div>
    ...
    <div class='ExamBody-checkbox'>
      <div class='QuestionTitle-checkbox'>
        <div class='title'>多选题第 <span>1</span> 题</div>
        <div class='TitleWord'>
          说明：以下多选题有四个选项，请选择所有正确答案，少选或不选不给分。
        </div>
      </div>
      <div class='WorkBody-checkbox'>
        <div class='QuestionWord-checkbox'>
          The headmaster hurried to the concert hall only ______ the speaker
        </div>
        <div class='choose-box'>
          <div class='chooses'>
            ...
            <div class='chooseThing'>awdawdaw</div>
          </div>
          <div class='chooses'>
            <div class='letter'>
              <div class='letters'>B</div>
            </div>
            <div class='chooseThing'>awdawawda</div>
          </div>
          <div class='chooses'>
            <div class='letter'>
              <div class='letters'>C</div>
            </div>
            <div class='chooseThing'>awdawd</div>
          </div>
          <div class='chooses'>
            <div class='letter'>
              <div class='letters'>D</div>
            </div>
            <div class='chooseThing'>awdwad</div>
          </div>
        </div>
        <div class='down'>
