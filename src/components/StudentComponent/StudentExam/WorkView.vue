<script setup>
import ExamChoose from '@/components/StudentComponent/StudentExam/ExamType/ExamChoose.vue'
import ExamTranslate from '@/components/StudentComponent/StudentExam/ExamType/ExamTranslate.vue'
import ExamCheckbox from '@/components/StudentComponent/StudentExam/ExamType/ExamCheckbox.vue'
import ExamJudge from '@/components/StudentComponent/StudentExam/ExamType/ExamJudge.vue'
import ExamWrite from '@/components/StudentComponent/StudentExam/ExamType/ExamWrite.vue'
import ExamAnswer from '@/components/StudentComponent/StudentExam/ExamType/ExamAnswer.vue'
import ExamListen from '@/components/StudentComponent/StudentExam/ExamType/ExamListen.vue'
import ExamSay from '@/components/StudentComponent/StudentExam/ExamType/ExamSay.vue'
import ExamBlank from '@/components/StudentComponent/StudentExam/ExamType/ExamBlank.vue'
