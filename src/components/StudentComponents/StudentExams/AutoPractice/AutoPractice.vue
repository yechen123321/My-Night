...
<template>
  <div class='AP'>
    <div class='AP-body'>
      <div class='AP-title'>
        <div class='Title-word'>自主练习系统</div>
      </div>
        ...
        <div class='MM'>
          ...
          <div class='Control'>
            ...
            <div v-if='showq || showp' class='Down'>
              <div style='margin-left: 3.5%' class='one'>
...
.beChoose {
  ...
  border-bottom: 2px solid #0e87ff !important;

  .icon {
    path {
      fill: #0e87ff !important;
    }
  }
}
...
.AP {
  ...
  .AP-body {
    ...
    .Body-Main {
      ...
      .Control {
        background: white;
        border: 1px solid rgba(106, 169, 153, 0.5);
        width: 67%;
        height: 70vh;
        border-radius: 0.3vw;
        box-shadow: 0 2px 6px 0 #6aa999;
        margin-left: 21.5%;
        position: absolute;
        ...
        .left-tips {
          ...
          .ul {
            ...
            .li:hover {
              cursor: pointer;
              color: #0e87ff;
              border-bottom: 2px solid #0e87ff;;
