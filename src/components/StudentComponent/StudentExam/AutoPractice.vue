...
const GotoMoniTalk = () => {
  router.push('/student/study/learn/talk')
}
      ...
      <div class='Body-Main'>
        <div class='MM'>
          ...
          <div class='Control' v-if='showpp'>
            <div class='Card' @click='GotoMoniTalk'>
              <div class='word'>英语口语训练</div>
            </div>
          </div>
        </div>
      </div>
    ...
    .Body-Main {
      ...
      .Control {
        ...
        .Card {
          ...
          margin-top: 3vh;
          margin-left: 2vw;
          background: url("/src/assets/talk.png") no-repeat;
